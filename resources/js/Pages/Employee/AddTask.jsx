...
const AddTask = ({ setIsFormVisible }) => {
  ...
  {isFormVisible && (
    <form
      ...
      className="bg-transparent p-8 rounded-lg shadow-none w-full max-w-xl ml-96"
    >
      ...
      <div className="mb-6">
        <input
          ...
          required
          className="w-full px-5 py-3 text-lg border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 transition bg-white"
        />
      </div>
      ...
      <button
        type="submit"
        className="w-full bg-orange-500 text-white py-3 rounded-md hover:bg-orange-600 transition-all duration-200 ease-in-out"
      >
        Create Task
      </button>
    </form>
