...
export default function Dashboard({ children, isFormVisible }) {
    ...
    // Handle text input with automatic bullets
    ...
    return (
        <AuthenticatedLayout>
            <div className="flex h-screen relative">
                {route().current() === 'dashboard' && !isFormVisible && (
                    ...
                    >
                        ...
                        <div className="mb-10">
                            <Link href={route('employee.add-task')} className="bg-blue-600 text-white p-2 rounded-full flex items-center justify-center hover:bg-blue-700">
                                <FaPlus size={24} />
                            </Link>
                        </div>
                    </div>
